...
RSpec.describe 'invoices show' do
  before :each do
    ...
    @discount1 = create(:discount, merchant: @merchant1, min_threshold: 10)
  ...
  it 'shows link to applied discounts if any' do
    within("#the-status-#{@ii_1.id}") do
      expect(page).not_to have_link("Applied discount")
    end
